package nlp.nii.win.corpus.stanford.treebank;

import java.io.Serializable;
import nlp.nii.win.corpus.stanford.util.Filter;
import nlp.nii.win.corpus.stanford.util.Filters;
...
public abstract class AbstractTreebankLanguagePack implements
	 ...
	 * Treebank), it makes the popBest guess that it can.
	 * 
	 * @return The Filter
	 */
